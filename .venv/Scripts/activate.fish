...
set -gx VIRTUAL_ENV 'C:\Users\Grigoriy_Klimanov\PycharmProjects\OOP_14_1_homework\.venv'
...
if test -n oop-14-1-homework-py3.14
    set -gx VIRTUAL_ENV_PROMPT oop-14-1-homework-py3.14
else
